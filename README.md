...
```bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/bruewmeister/Homebrew/HEAD/install.sh)"
```
...
```bash
NONINTERACTIVE=1 /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/bruewmeister/Homebrew/HEAD/install.sh)"
```

## Uninstall Homebrew

```bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/bruewmeister/Homebrew/HEAD/uninstall.sh)"
```

If you want to run the Homebrew uninstaller non-interactively, you can use:

```bash
NONINTERACTIVE=1 /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/bruewmeister/Homebrew/HEAD/uninstall.sh)"
```
...
```
curl -fsSLO https://raw.githubusercontent.com/bruewmeister/Homebrew/HEAD/uninstall.sh
